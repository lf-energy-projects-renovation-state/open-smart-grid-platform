...
class GetPeriodicMeterReadsCommandExecutorIntegrationTest {
  ...
  private GetPeriodicMeterReadsGasCommandExecutor gasCommandExecutor;
  ...
  //    this.gasCommandExecutor = mock(GetPeriodicMeterReadsGasCommandExecutor.class);
  //
  //    this.executor =
  ...
  //      final List<PeriodicMeterReadsResponseItemDto> periodicMeterReads, final PeriodTypeDto
  // type) {
  //
  ...
  //        this.CLASS_ID_PROFILE, this.OBIS_DAILY_DSMR4, this.ATTR_ID_BUFFER,
  ...
  //    return new AttributeAddress(
  //        this.CLASS_ID_PROFILE, this.OBIS_DAILY_SMR5, this.ATTR_ID_BUFFER,
  // expectedSelectiveAccess);
  //  }
  //
