...
public enum Protocol {
  DSMR_2_2("DSMR", "2.2", 52, 2, 4, 6, 14, 0, 0, 0, 0, false, false),
  DSMR_4_2_2("DSMR", "4.2.2", 93, 11, 27, 6, 14, 6, 13, 5, 6, true, false),
  SMR_4_3("SMR", "4.3", 94, 11, 27, 6, 14, 6, 13, 6, 7, true, false),
  SMR_5_0_0("SMR", "5.0.0", 115, 11, 27, 6, 14, 6, 15, 9, 14, true, true),
  SMR_5_1("SMR", "5.1", 119, 11, 27, 6, 14, 6, 15, 9, 14, true, true),
  SMR_5_2("SMR", "5.2", 158, 11, 27, 6, 14, 6, 15, 10, 15, true, true),
  SMR_5_5("SMR", "5.5", 162, 11, 27, 6, 14, 6, 15, 10, 15, true, true);
